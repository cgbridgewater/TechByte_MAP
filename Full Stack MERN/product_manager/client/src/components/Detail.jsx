...
const Detail = () => {
    ...
    return (
        <div>
            ...
            {/* main content */}
                <div style={{margin:"auto", marginBottom:"10px", marginTop:"30px",padding:"30px", height:"300px", width:"50%",backgroundColor:"goldenrod", border:"2px solid white", borderRadius:"15px"}}>
                ...
                <div style={{display:"flex", justifyContent:"space-evenly"}}>
                    ...
                    <Link className='ViewButton' to="/home" style={{ width:"auto", textDecoration: "none",backgroundColor:"goldenrod",border:"none",color:"blue", fontWeight:"800" }}> Home Page</Link>
                </div>
            </div>
        }</div>    // ternary ender
    );
