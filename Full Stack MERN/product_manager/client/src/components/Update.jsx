            ...
            <div style={{backgroundColor:"#073daa", minHeight:"70vh"}}>
                ...
                <form onSubmit={updateItem}>
                    <div>
                        ...
                        <input style={{marginTop:"5px",backgroundColor:"lightgray", fontSize:"20px", fontWeight:800, border:"2px solid goldenrod", borderRadius:"15px", width:"40%"  }} 
                        type="text" 
                    ...
                    <div>
                        ...
                        <textarea style={{marginTop:"5px",backgroundColor:"lightgray", fontSize:"20px", fontWeight:800, border:"4px solid goldenrod", borderRadius:"15px", width:"40%"  }} 
                        cols="40" 
                        rows="7"  
                ...
                <div style={{display:"flex", justifyContent:"space-evenly", marginTop:"10px"}}>
                    <button
                        style={{width:"auto"}}                    className='DeleteButton'
                        onClick={(e) =>{deleteItem(id)}}>
                        Delete Item
                    </button>
                    <Link to="/home" className='ViewButton' style={{ width:"auto", textDecoration: "none",backgroundColor:"goldenrod",border:"none",color:"blue", fontWeight:"800"}}>Home Page</Link>
                </div>
            </div>
        }</div>    // ternary ender
    )
