...
const Main = () => {
    ...
    return(
        <div>
            ...
            <hr style={{width:"80%",height:"10px", margin:"25px auto", backgroundColor:"goldenrod", border:"2px solid white", borderRadius:"10px",  boxShadow:"0 8px 12px 0 rgba(0, 0, 0, 0.70)"}} />
